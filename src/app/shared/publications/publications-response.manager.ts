...
export interface NewPublicationResponseInterface extends GenericResponseInterface {
  data: PublicationInterface;
}

export interface DeletePublicationResponseInterface extends GenericResponseInterface {
  data: {
